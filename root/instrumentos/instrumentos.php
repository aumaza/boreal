...
<div class="navbar-header">
  ...
  <a class="navbar-brand"><strong>Instrumentos </strong><span class="glyphicon glyphicon-cd"></a>
</div>
...
<!-- Links -->
    <ul class="nav navbar-nav navbar-right">
      <li class="active" ><a href="../instrumentos/nuevoRegistro.php">Ingresar Registro <span class="glyphicon glyphicon-plus"></span></a></li>
    </ul>
<!-- Search -->
</div>
</div>
	...
	$i=0;
            echo "<table class='display compact' id='myTable'>";
              echo "<thead>
                    ...
                    <th class='text-nowrap text-center'>Instrumento</th>
                    <th>&nbsp;</th>
                    </thead>";
