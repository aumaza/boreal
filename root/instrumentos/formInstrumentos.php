...
$sqlInsert = "INSERT INTO instrumentos ".
"(descripcion)".
"VALUES ".
"('$descripcion')";
...
<html><head>
	<meta charset="utf-8">
	<title>Instrumento Guardado</title>
...
<div class="section">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">Instrumentos</h1>
                            </div>
                            <div class="panel-body">
                                <p><strong>Nuevo Instrumento</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
