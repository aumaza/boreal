...
<div class="section">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h1 class="panel-title text-center" contenteditable="true">Instrumentos - Editar Instrumento</h1>
                            </div>
        ...
        <div class="section">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Instrumento" value="<?php echo $fila['descripcion']; ?>">
			</div>
				</div>
