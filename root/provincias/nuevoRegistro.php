                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h1 class="panel-title text-center" contenteditable="true">Provincias - Nueva Provincia</h1>
                            </div>
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form action="../provincias/formProvincias.php" method="POST" class="form-horizontal" role="form">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Provincia">
			</div>
				</div>
