                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h1 class="panel-title text-center" contenteditable="true">Estilo Musical - Editar Estilo</h1>
                            </div>
                    ...
                    <div class="col-md-8">
                        <form action="formUpdate.php" method="POST" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                             <div class="col-sm-2">
                                    <label for="estilo" class="control-label">Estilo Musical</label>
				</div>

			<div class="col-sm-10">
				<input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Estilo Musical" value="<?php echo $fila['descripcion']; ?>">
			</div>
				</div>
