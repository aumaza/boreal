                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h1 class="panel-title text-center" contenteditable="true">Estilos Musicales - Nuevo Estilo</h1>
                            </div>
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <form action="../genre/formGenre.php" method="POST" class="form-horizontal" role="form">
                            <div class="form-group">
                                <div class="col-sm-2">
                                    <label for="localidad" class="control-label">Estilo Musical</label>
				</div>

			<div class="col-sm-10">
				<input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Estilo Musical">
			</div>
				</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<hr> <a href="../genre/genre.php"><input type="button" value="Volver" class="btn btn-primary"></a>
