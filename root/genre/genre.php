...
<div class="navbar-header">
  ...
  <a class="navbar-brand"><strong>Estilos Musicales </strong><span class="glyphicon glyphicon-music"></a>
</div>
...
<!-- Links -->
    <ul class="nav navbar-nav navbar-right">
      <li class="active" ><a href="../genre/nuevoRegistro.php">Nuevo Registro <span class="glyphicon glyphicon-plus"></span></a></li>
    </ul>
<!-- Search -->
</div>
</div>
	...
	$i=0;
            echo "<table class='display compact' id='myTable'>";
              echo "<thead>
                    ...
                    <th class='text-nowrap text-center'>Estilo</th>
                    <th>&nbsp;</th>
                    </thead>";
